                                    ...
                                    if(4== sensorData[i].gas_index)
                                      {
                                        ...
                                        if (i == 0)
                                        {
                                            ...
                                            {
                                              case 0:
                                              gas = normalize(old_gas_resistance, 144591.92, 669718.75);
                                              sendI2C_32(ASIC_DEV_ADDR, ASIC_VOC1_REG_ADDR, gas);
                                              break;

                                              case 1:
                                              gas = normalize(old_gas_resistance, 137931.03, 7706491);
                                              sendI2C_32(ASIC_DEV_ADDR, ASIC_VOC2_REG_ADDR, gas);
                                              break;

                                              case 2:
                                              gas = normalize(old_gas_resistance, 78263.53, 28364424);
                                              sendI2C_32(ASIC_DEV_ADDR, ASIC_VOC3_REG_ADDR, gas);
                                              break;

                                              case 3:
                                              gas = normalize(old_gas_resistance, 39384.62, 4870392.5);
                                              sendI2C_32(ASIC_DEV_ADDR, ASIC_VOC4_REG_ADDR, gas);
                                              break;
                                              
                                              case 4:
                                              gas = normalize(old_gas_resistance, 77201.45, 539942);
                                              sendI2C_32(ASIC_DEV_ADDR, ASIC_VOC5_REG_ADDR, gas);
                                              sendI2C_32(ASIC_DEV_ADDR, ASIC_CONTROL_REG_ADDR, byte(0x02))
                                              break;
