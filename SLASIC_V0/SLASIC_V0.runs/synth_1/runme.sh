...
HD_PWD='C:/Users/cengi/OneDrive/Desktop/SLASIC/SL-ASIC-NOSE/SLASIC_V0/SLASIC_V0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Single_Cycle_RISCV32I.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Single_Cycle_RISCV32I.tcl
