...
HD_PWD='C:/Users/ethem/IC_Project/IC_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Single_Cycle_RISCV32I.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Single_Cycle_RISCV32I.tcl -notrace
