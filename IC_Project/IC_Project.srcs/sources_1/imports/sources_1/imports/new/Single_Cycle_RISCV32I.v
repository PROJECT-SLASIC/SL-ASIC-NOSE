module Single_Cycle_RISCV32I#(parameter width = 32)(
    ...
    input sda_m,  // LCD Driver SDA
    output scl_m, // LCD Driver SCL
    
    input sda_s,  // I2C Slave SDA
    output scl_s, // I2C Slave SCL
    );
...
//        . PCSrc(PCSrc_top),//ok
    ...
    Data_Memory_1 Data_Memory(
        ...
        . tx_is_busy(tx_busy_wire),
        . tx_done(tx_done_tick_wire),
//        . enable(enable_wire),
